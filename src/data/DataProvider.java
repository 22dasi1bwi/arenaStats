...
public class DataProvider {
	...
	public static void provideData() {
		...
		new Fight(new Combination(Class.DRUID_RESTORATION, Class.DEMONHUNTER_HAVOC),
				new Build(Sets.newHashSet(Talent.BLESSED_HANDS, Talent.BLIND)), Class.DRUID_RESTORATION, Result.WIN,
				"");
		new Fight(new Combination(Class.MAGE_FIRE, Class.MAGE_FIRE),
		...
		new Fight(new Combination(Class.PALADIN_HOLY, Class.DEATHKNIGHT_FROST),
				...
				Class.PALADIN_HOLY, Result.DEFEAT, "");
		new Fight(
				new Combination(Class.ROGUE_SUBTLETY, Class.MAGE_FIRE), new Build(Sets.newHashSet(Talent.CRUSADER,
		...
		new Fight(new Combination(Class.DRUID_RESTORATION, Class.SHAMAN_ELEMENTAL),
				new Build(Sets.newHashSet(Talent.CRUSADER, Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE,
						Talent.BEACON_OF_FAITH)),
		...
		new Fight(new Combination(Class.DRUID_RESTORATION, Class.WARRIOR_ARMS),
				...
				Class.WARRIOR_ARMS, Result.DEFEAT, "");
		new Fight(
				new Combination(Class.DEATHKNIGHT_UNHOLY, Class.MAGE_FIRE), new Build(Sets.newHashSet(Talent.CRUSADER,
						Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE, Talent.BEACON_OF_FAITH)),
				Class.MAGE_FIRE, Result.WIN, "");
		...
		new Fight(
				new Combination(Class.MAGE_FROST, Class.ROGUE_SUBTLETY), new Build(Sets.newHashSet(Talent.CRUSADER,
						Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE, Talent.BEACON_OF_FAITH)),
				Class.MAGE_FROST, Result.DEFEAT, "");
		new Fight(new Combination(Class.DRUID_RESTORATION, Class.SHAMAN_ENHANCEMENT),
				new Build(Sets.newHashSet(Talent.BLESSED_HANDS, Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE)),
		...
		new Fight(
				new Combination(Class.PALADIN_HOLY, Class.PRIEST_SHADOW), new Build(Sets.newHashSet(Talent.CRUSADER,
						Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE, Talent.BEACON_OF_FAITH)),
				Class.PRIEST_SHADOW, Result.DEFEAT, "");
		new Fight(new Combination(Class.PALADIN_HOLY, Class.DEATHKNIGHT_UNHOLY),
				new Build(Sets.newHashSet(Talent.CRUSADER, Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE,
		...
		new Fight(new Combination(Class.PRIEST_DISCIPLINE, Class.DEMONHUNTER_HAVOC),
				...
				Class.PRIEST_DISCIPLINE, Result.WIN, "");
		new Fight(
				new Combination(Class.MAGE_FIRE, Class.DEMONHUNTER_HAVOC), new Build(Sets.newHashSet(Talent.CRUSADER,
						Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE, Talent.BEACON_OF_FAITH)),
				Class.MAGE_FIRE, Result.DEFEAT, "consider bubble rather than bop");
		new Fight(
				new Combination(Class.MAGE_FIRE, Class.MONK_MISTWEAVER), new Build(Sets.newHashSet(Talent.CRUSADER,
						Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE, Talent.BEACON_OF_FAITH)),
				Class.MAGE_FIRE, Result.WIN, "");
		...
		new Fight(new Combination(Class.WARRIOR_FURY, Class.DEMONHUNTER_HAVOC),
				...
				Class.WARRIOR_FURY, Result.WIN, "");
		new Fight(
				new Combination(Class.MAGE_FIRE, Class.ROGUE_ASSASINATION), new Build(Sets.newHashSet(Talent.CRUSADER,
		...
		new Fight(new Combination(Class.PRIEST_DISCIPLINE, Class.WARLOCK_AFFLICTION),
				new Build(Sets.newHashSet(Talent.CRUSADER, Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE,
						Talent.BEACON_OF_FAITH)),
				Class.WARLOCK_AFFLICTION, Result.WIN, "");
		new Fight(
				new Combination(Class.DRUID_FERAL, Class.PALADIN_HOLY), new Build(Sets.newHashSet(Talent.CRUSADER,
						Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE, Talent.BEACON_OF_FAITH)),
		...
		new Fight(new Combination(Class.MONK_WINDWALKER, Class.DEMONHUNTER_VENGEANCE),
				new Build(Sets.newHashSet(Talent.BLESSED_HANDS, Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE)),
				Class.MONK_WINDWALKER, Result.DEFEAT, "");
		new Fight(new Combination(Class.WARLOCK_AFFLICTION, Class.SHAMAN_RESTORATION),
				new Build(Sets.newHashSet(Talent.CRUSADER, Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE,
						Talent.BEACON_OF_FAITH)),
				Class.WARLOCK_AFFLICTION, Result.WIN, "");
		new Fight(new Combination(Class.DRUID_RESTORATION, Class.MAGE_FROST),
		...
		new Fight(
				...
				Class.PRIEST_SHADOW, Result.DEFEAT, "");
		new Fight(new Combination(Class.HUNTER_SURVIVAL, Class.DRUID_RESTORATION),
				new Build(Sets.newHashSet(Talent.CRUSADER, Talent.BLIND, Talent.GLADIATOR, Talent.BEACON_OF_FAITH,
						Talent.LIGHTS_GRACE)),
				Class.HUNTER_SURVIVAL, Result.DEFEAT, "");
		new Fight(new Combination(Class.DEMONHUNTER_HAVOC, Class.MONK_MISTWEAVER),
				new Build(Sets.newHashSet(Talent.CRUSADER, Talent.BLIND, Talent.GLADIATOR, Talent.BEACON_OF_FAITH,
						Talent.LIGHTS_GRACE)),
		...
		new Fight(new Combination(Class.MAGE_FIRE, Class.PALADIN_RETRIBUTION),
				new Build(Sets.newHashSet(Talent.CRUSADER, Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE)),
				Class.MAGE_FIRE, Result.DEFEAT, "");
		new Fight(new Combination(Class.WARLOCK_AFFLICTION, Class.MONK_WINDWALKER),
				new Build(Sets.newHashSet(Talent.CRUSADER, Talent.BLIND, Talent.GLADIATOR, Talent.LIGHTS_GRACE,
						Talent.BEACON_OF_FAITH)),
				Class.WARLOCK_AFFLICTION, Result.WIN, "");
		new Fight(new Combination(Class.DRUID_RESTORATION, Class.DEMONHUNTER_HAVOC),
