...
public class StatisticPrinter {
    ...
    private void printStatisticForCombination() {
        ...
        System.out.println("Matches were lost with the following builds: " + fightInformation.getBuildsThatLostFights());
    }
    ...
    private void printOverallClassOccurrence() {
        ...
        overallClassOccurrence.entrySet().stream().sorted(Map.Entry.<WoWClass, Double> comparingByValue().reversed()).forEach(
