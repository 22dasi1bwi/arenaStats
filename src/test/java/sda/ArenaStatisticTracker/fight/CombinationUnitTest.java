...
public class CombinationUnitTest {
	...
	public void shouldReturnFalseForDifferentCombinationSize(){
		Combination comb1 = new Combination(Arrays.asList(WoWClass.DEMONHUNTER_HAVOC, WoWClass.DRUID_RESTORATION));
		Combination comb2 = new Combination(Arrays.asList(WoWClass.DEMONHUNTER_HAVOC, WoWClass.DRUID_RESTORATION, WoWClass.WARLOCK_AFFLICTION));
		Combination comb3 = new Combination(Arrays.asList(WoWClass.DEMONHUNTER_HAVOC, WoWClass.DRUID_RESTORATION, WoWClass.WARLOCK_AFFLICTION, WoWClass.PALADIN_HOLY, WoWClass.SHAMAN_ELEMENTAL));
